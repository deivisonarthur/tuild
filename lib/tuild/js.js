	...
	commands:{
		...
		'-h': function(){
			...
			console.log(
				...
				'USAGE:\n' + 
				'tuild js -h --help -q --quiet -dev -min -minifield -hint --watch --no-hint [file > file] [file1|file2|fileN > file] [folder > file] \n\n' +
				...
				'-min					DEFAULT OPTION. create a file with the minifield code of your js files \n' + 
				'-minifield				only return the js code minifield. None file is created/edited \n' + 
				'-hint					only check your code with jsHint. None file is created/edited \n' + 
				'--watch					watch the file(s)/folder to automatically change the target js file. Press CMD+C or CTRL+C to unwatch and exit the process \n' +
